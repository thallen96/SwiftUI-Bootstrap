...
struct HomeView: View {
    ...
    var body: some View {
        ZStack{
            VStack{
                NavigationBarView(title: "Welcome to hell", leftButton: nil, rightButton: NavButton.profilePic(imageURL: nil, caption: "User", tapFunction: {}, frameColor: Color.gray), backgroundColor: nil, titleColor: nil)
                Spacer()
            }
            VStack{
                Spacer()
